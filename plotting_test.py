...
from src.plotting.model_plotting_utils import plot_bar, plot_img, plot_img_row, plot_img_label_grid, plot_img_label_pred, plot_model_figures
...
if __name__ == "__main__":
    ...
    plot_model_figures(model_path="./models/u_net_supervised/Mean Squared Error_20.pt")
