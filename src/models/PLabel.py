...
class PLabel(nn.Module, ReporterMixin):
    ...
    """ Latest changes by Alexei 02/04.
        
        1) Replaced the use of historic pseudolabels with a set of pseudolabels
        generated by argmaxing the unlabelled outuput. 
        2) Replaced sum reduction in loss calculation with mean for stability
